...
int main(){
    ...
    printf("------ Processo Consumidor iniciou! ------\n");    

    while(1){
        S0.down();
        if(*qItens > 0){
                printf("Remoção de item do buffer iniciada!\n");
                *qItens -= 1;                
                printf("Remoção de item do buffer bem-sucedida!\n");
        ...
        S0.up();
        printf("Consumidor dormindo por 5 segundos!\n");
        sleep(5);
    }
